jQuery(document).ready(function($) {
   ...
   // Update hrefs dynamically based on current URL
   // Handle language selection
   $('.lang-option').each(function() {
       var lang = $(this).data('lang');
       var newHref = '';

       // Assuming default language is 'nl' for client-side logic, or passed via window.aiTranslateDetectable
       var defaultLang = window.aiTranslateDetectable ? window.aiTranslateDetectable.default_language : 'nl';
   ...
   $(document).on('click', '.lang-option', function(e) {
       ...
       var lang = $(this).data('lang');
       var url = $(this).attr('href'); // Get the URL generated by the .each() loop
       ...
       // Navigate to the URL provided in the href (which is now always the homepage of the target language)
   ...
   $(document).on('click', '.lang-option', function(e) {
       e.preventDefault(); // Prevent default link behavior first
       var lang = $(this).data('lang');
       var url = $(this).attr('href'); // Get the dynamically generated URL
