...
- Woocommerce product names issues resolved with accented slugs and old slugs. 
- The plugin is now aware of password protected pages and invalidates cached version.
...
- Adviced models on top per API provider.
